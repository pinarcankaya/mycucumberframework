...
public class ScenarioOutlineExampleSteps {
    ...
    public void user_enters_first_name() {
        dataTablePage.fistname.sendKeys("PIN");
    }
    ...
    public void user_enters_salary() {
       dataTablePage.salary.sendKeys("120000");
    }
    ...
    public void user_enters_first_name_to_the_searchbox() {
        dataTablePage.searchbox.sendKeys("PIN");
    }
    ...
    public void verify_that_user_see_the_first_name_in_the_searchbox() {
       String name= dataTablePage.nameField.getText();///isim alanindaki texti al
        Assert.assertTrue(name.contains("PIN" + ""));
    }
    ////***********************************///
    @When("User enters first name {string}")
    public void user_enters_first_name(String string) {
       dataTablePage.fistname.sendKeys(string);
    }
